...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        NSDictionary * channelAttributes = @{@"sdk": @"react-native", @"react-native": @"3.9.57" };
...
- (NSDictionary *)constantsToExport {
    ...
    return @{@"pluginVersion": @"3.9.57", @"sdkVersion": MCESdk.sharedInstance.sdkVersion, @"appKey": config.appKey ? config.appKey : [NSNull null]};
}
