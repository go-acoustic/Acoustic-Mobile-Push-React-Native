    ...
    return (
      <ScrollView style={styles.scrollView}>
        ...
        {/* <ListItem style={styles.firstRow}
          title="Bottom Banner Template"
          onPress={() => RNAcousticMobilePushInApp.executeInApp(['bottomBanner'])}
        /> */}
        {/* <ListItem style={styles.row}
          title="Top Banner Template"
          onPress={() => RNAcousticMobilePushInApp.executeInApp(['topBanner'])}
        />
        <ListItem style={styles.row}
          title="Image Template"
          onPress={() => RNAcousticMobilePushInApp.executeInApp(['image'])}
        />
        <ListItem style={styles.row}
          title="Video Template"
          onPress={() => RNAcousticMobilePushInApp.executeInApp(['video'])}
        />
        <ListItem style={styles.row}
          title="Next Template"
          onPress={() => RNAcousticMobilePushInApp.executeInApp(['all'])}
        />
        <Text style={styles.tableHeader}>Add Canned InApp</Text>
        <ListItem style={styles.firstRow}
          title="Bottom Banner Template"
          onPress={this.createBottomBanner}
        />
        <ListItem style={styles.row}
          title="Top Banner Template"
          onPress={this.createTopBanner}
        />
        <ListItem style={styles.row}
          title="Image Template"
          onPress={this.createImageTemplate}
        />
        <ListItem style={styles.row}
          title="Video Template"
          onPress={this.createVideoTemplate}
        /> */}
      </ScrollView>
    );
  }
